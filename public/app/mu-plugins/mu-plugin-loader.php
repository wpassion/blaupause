...
namespace Blaupause\MuPluginLoader;
...
function _get_plugins(bool $forceLoad = false): array
{
...
function _transient_key(array $dirs): string
{
...
function _transient_expiration(): int
{
