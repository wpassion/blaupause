 ...
 * Version: 1.0.0
 * Author: Jan Sorgalla
 * Author URI: https://sorgalla.com
 */

namespace Blaupause\RegisterThemeDirectory;
...
function _get_app_theme_path(): string
{
    static $themePath;
...
function _detect_wp_home_path(): string
{
    $homePath = __DIR__;
...
function _is_stored_app_theme_path($path): bool
{
